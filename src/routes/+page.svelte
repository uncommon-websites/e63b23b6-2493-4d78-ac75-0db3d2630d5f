...
<Hero
	title="Test ideas. Skip the guesswork."
	subtitle="Validate new features with real user data."
	imageSrc="/generated/image-a-group-of-professional-product-managers.webp"
	centered={false}
/>
<LogoScroller 
